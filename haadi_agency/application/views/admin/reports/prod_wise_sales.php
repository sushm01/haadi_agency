...
<section class="content">
  <div class="row">
    ...
    <a class="far fa-edit" onclick="setDataFunction(
        '<?php echo isset($r->id) ? $r->id : ''; ?>',
        '<?php echo isset($r->category) ? htmlspecialchars($r->category, ENT_QUOTES, 'UTF-8') : ''; ?>'
    )" style="font-size: 25px; color: YellowGreen;"></a>

    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <a class="fas fa-trash-alt" onclick="setDeleteFunction('<?php echo isset($r->id) ? $r->id : ''; ?>')" 
       style="font-size:25px; color: IndianRed"></a> 
</td>
 -->
            </tr>
            <?php $i++; ?>
...
function loadData() {
    ...
    $.ajax({
        url: "<?php echo base_url('welcome/fetch_item_wise_report'); ?>",
        type: "POST",
